...
class AISMessagesQuery:
    ...
    Args:
        ...
        query_template (str, optional): template to use for queries.
    """

    def __init__(self, client: Any, query_template: str = QueryTemplate.AIS_MESSAGES):
        self._client = client
    ...
    def run(self, start_date: date, end_date: date, ssvids: list = None) -> AISMessagesQueryResult:
        """Executes the query.
