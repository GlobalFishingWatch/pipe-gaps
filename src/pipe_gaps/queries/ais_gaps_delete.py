"""This module encapsulates a DELETE query for AIS raw gaps."""
import logging
...
class AISGapsDeleteQuery(Query):
    """Encapsulates a DELETE query for AIS raw gaps.
